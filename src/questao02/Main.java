...
public class Main {
    public static void main(String[] args) throws IOException {
        File img = new File("src/questao02/Imagens-Ruido");
        ...
        for (File imagens : img.listFiles()) {
            ...
            for (int linha = desvioVizinhanca; linha < altura - desvioVizinhanca; linha++) {
                for (int coluna = desvioVizinhanca; coluna < largura - desvioVizinhanca; coluna++) {
                    ...
                    newImg.setRGB(coluna, linha, newColor.getRGB());
                }
            }


            String nomeArquivoSaida = "src/questao02/limpas/l9x9/" + imagens.getName().replace(".jpg", "clean9x9.png");
            ImageIO.write(newImg, "png", new File(nomeArquivoSaida));
